                  ...
                  <div className="flex flex-col justify-between w-full">
                    <div className="flex flex-1 ">
                        ...
                        <div className="relative">
                            <label className="absolute px-2 ml-2 -mt-3 text-gray-600 bg-white font-semibold">Name</label>
                            <input type="text" className="block w-full px-4 py-3 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-purple-600" name="name" placeholder="Give your basket a name"/>
                        </div>
                        <div className="relative">
                            <label className="absolute px-2 ml-2 -mt-3 text-gray-600 bg-white font-semibold">Description</label>
                            <textarea className="block w-full px-4 py-3 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-purple-600" name="name" placeholder="What's your basket about?"></textarea>
                        </div>
