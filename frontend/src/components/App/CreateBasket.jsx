        ...
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex items-center justify-center pt-6 text-center">
              ...
              >
                <Dialog.Panel className="max-w-xl h-full transform overflow-hidden bg-white p-6 text-left align-middle shadow-xl transition-all">
                  <Dialog.Title
                    as="h3"
                  ...
                  <div className="flex flex-col justify-between w-full">
                    <div className="flex flex-1 ">
                        ...
                        <div class="relative">
                            <label class="absolute px-2 ml-2 -mt-3 font-medium text-gray-600 bg-white font-semibold">Name</label>
                            <input type="text" class="block w-full px-4 py-3 mt-2 text-base placeholder-gray-400 bg-white border border-gray-300 rounded-md focus:outline-none focus:border-black" name="name" placeholder="Give your basket a name"/>
                        </div>
                        </form>
                    </div>
